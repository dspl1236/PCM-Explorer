"""Vendored from PCM-Forge (PCM4/tools/lzo1x.py), MIT, same author.
Kept in-tree so PCM Explorer stays dependency-free -- decoding a firmware
image must not require liblzo2, a C compiler, or python-lzo.
"""
#!/usr/bin/env python3
